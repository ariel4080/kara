...
class _$AppointmentModelImpl implements _AppointmentModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, businessId, date,
      time, durationMinutes, status, createdAt, service, notes);
...
abstract class _AppointmentModel implements AppointmentModel {
  const factory _AppointmentModel(
      ...
      final String? notes}) = _$AppointmentModelImpl;
...
abstract class _ServiceModel implements ServiceModel {
  const factory _ServiceModel(
      ...
      required final String icon}) = _$ServiceModelImpl;
